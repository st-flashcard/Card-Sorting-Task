...
def show_test():
    ...
    # iOS対応方式：SVGをHTMLで表示してボタンを下に配置
    # background-imageのCSSセレクタは当たらないので廃止
    # SVGカード表示(上) + on_clickボタン(下) を視覚的に一体化したデザイン
    st.markdown("""
    <style>
    /* カード下部のボタン */
